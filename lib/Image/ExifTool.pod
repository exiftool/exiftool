...
3) [optional] 'Link' or 'SymLink' to create a hard or symbolic link instead
of renaming the file, or 'Test' to test renaming feature by printing the old
and new names instead of changing anything.
...
JFIF, JFXX, JPEG, JPEG-HDR, JSON, JVC, Jpeg2000, KDC_IFD, Kodak,
...
MediaJukebox, MetaIFD, Microsoft, Minolta, MinoltaRaw, Motorola, NITF,
...
Track#, VCalendar, VCard, Version0, Vorbis, WTV, XML, XMP, XMP-DICOM,
XMP-GAudio, XMP-GImage, XMP-GPano, XMP-GSpherical, XMP-MP, XMP-MP1,
