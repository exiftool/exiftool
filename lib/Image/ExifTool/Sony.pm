...
# March 2019: ILCE-9 with v5.00 firmware follows ILCE-6400 in many tags ...
    0x0050 => {
        Name => 'ShutterCount2',
        Condition => '(($$self{FlashFired} & 0x01) != 1) and ($$self{Model} =~ /^(ILCE-(6400|7RM4))/ or $$self{Software} =~ /^ILCE-9 v5.00/)',
        Format => 'int32u',
        RawConv => '$val & 0x00ffffff',
    },
    0x0052 => {
...
# 0x0058, 0x0061:  E-Mount: ShutterCount and dateTime
    0x0058 => { # appears not valid when flash is used ... not for ILCA-99M2
        Name => 'ShutterCount2',
        Condition => '(($$self{FlashFired} & 0x01) != 1) and ($$self{Model} !~ /^(ILCA-99M2|ILCE-(6400|7M3|7RM3|7RM4))/) and $$self{Software} !~ /^ILCE-9 v5.00/',
        Format => 'int32u',
        RawConv => '$val & 0x00ffffff',
    },
...
%Image::ExifTool::Sony::Tag9400c = ( #JR
    ...
    NOTES => q{
        ...
        WX500, ILCE-7/7R/7S/7M2/7M3/7RM2/7RM3/7SM2/9/5000/5100/6000/6300/6400/6500/
