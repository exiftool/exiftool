...
%compression = (
  ...
  # 34888,34889 - ESRI reserved
    ...
    34925 => 'LZMA2', #LibTiff
    34926 => 'Zstd', #LibTiff (Dubious...)
    34927 => 'WebP', #LibTiff (Dubious...)
    34933 => 'PNG', # (TIFF mail list)
    34934 => 'JPEG XR', # (TIFF mail list)
    50000 => 'Zstd', # (libtiff tiff.h)
    50001 => 'WEBP', # (libtiff tiff.h)
    50002 => 'JPEG XL (deprecated)', # (libtiff tiff.h, as generated by GDAL < 3.11)
