...
%Image::ExifTool::Lang::ru::Translate = (
   ...
   'AINumLayers' => 'AI – Количество слоев',
   'AIRulerUnits' => {
   ...
   'AlphaIdentifiers' => 'Идентификаторы альфа',
   ...
   'CopyrightOwner' => 'Правообладатель(ы)',
   ...
   'FileHardLinks' => 'Жесткие ссылки файла',
   'FileID' => 'ID файла',
   ...
   'Latitude' => 'Широта',
   'LayerBlendModes' => {
      Description => 'Режим наложения слоев',
      PrintConv => {
        'Color' => 'Цветность',
   ...
   'LayerGroupsEnabledID' => 'ID включенных групп слоев',
   'LayerIDs' => 'ID слоев',
   'LayerModifyDates' => 'Дата изменения слоя',
   'LayerNames' => 'Названия слоев',
   'LayerOpacities' => 'Непрозрачность слоя',
   'LayerRectangles' => 'Прямоугольники слоя',
   'LayerSelectionIDs' => 'Идентификаторы выборанного слоя',
   'LayerUnicodeNames' => 'Юникодные названия слоев',
   'LayersGroupInfo' => 'Информация о группе слоев',
   'Layout' => {
      Description => 'Макет',
      PrintConv => {
   ...
   'LicensorEmail' => 'Email адрес лицензора',
   'LicensorExtendedAddress' => 'Дополнительные Email адреса лицензора',
   ...
   'LocalDefaultAlarm' => 'Local Сигнал по умолчанию ',
   ...
   'MDItemAuthorEmailAddresses' => 'MD Item – Email автора',
   ...
   'MDItemEmailConversationID' => 'MD Item – ID переписки по Email',
   ...
   'MDItemPrimaryRecipientEmailAddresses' => 'MD Item – Email адреса первичного получателя',
   ...
   'RegionPersonEmailDigest' => 'Хеш-сумма Email Windows Live пользователя',
   ...
   'Text' => 'Текст',
   'TextLayerName' => 'Названия текстовых слоев',
   ...
   'TriggerMode' => {
      ...
      PrintConv => {
        'CodeLoc Not Entered' => 'CodeLoc не введен',
   ...
   'UnicodeAlphaNames' => 'Юникодное название альфа',
