...
%Image::ExifTool::Lang::de::Translate = (
   ...
   'AFPointsInFocus' => {
      ...
      PrintConv => {
        '(none)' => 'Auf Mitte fixiert oder mehrere',
        'All' => 'Alle',
